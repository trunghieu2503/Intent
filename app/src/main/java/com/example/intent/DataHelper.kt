...
class DataHelper(context: Context) :
    ...
    fun addStudent(student: Student) {
        ...
        val values = ContentValues().apply {
            put(COLUMN_NAME, student.name) // Gán giá trị tên sinh viên
            put(COLUMN_CLASS, student.className) // Gán giá trị lớp học
            put(COLUMN_IS_JOINED, student.isJoined) // Gán giá trị trạng thái tham gia
        }
